...
var JoomMenuModule = new Class({
  ...
  initialize: function(options){
    ...
    this.catTitle.setHTML(this.options.catTitle);
    ...
    this.closeLink.setStyles({
      ...
      'width'         : '25px',
      'height'        : '25px',
      'background'    : 'transparent url(' + this.options.baseURL + 'modules/mod_joommenu/assets/close.png) no-repeat center'
    });
  ...
  positionSlideshowControl: function(){
    ...
    this.slideshowcontrolheight  = parseInt((this.closeLink.getStyle('height')), 10);
  ...
  fadeSlideshow: function(fadeIn){
    if(fadeIn){
      ...
      var fadeOverlayfx = new Fx.Styles(this.overlay, {
        ...
        var fadeSlideshowControlfx = new Fx.Styles(this.slideshowcontrol, {
          duration: 500,
          wait: true,
          transition: Fx.Transitions.Quad.easeOut
        });
...
JoomMenuModule.implement(new Options);
