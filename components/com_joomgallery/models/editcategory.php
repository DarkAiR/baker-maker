...
// $Id: editcategory.php 2658 2011-01-16 20:50:24Z mab $
/****************************************************************************************\
**   JoomGallery  1.5.6                                                                 **
...
class JoomGalleryModelEditcategory extends JoomGalleryModel
{
  ...
  function store()
  {
    ...
    if($isNew)
    {
      // Check whether the user is allowed to store the category into the specified parent category
      if(!$valid_parent)
      {
